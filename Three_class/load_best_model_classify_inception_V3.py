...
model.load_weights("inceptionv3_weights_amd_cnv_dme.best.hdf5")
...
#following few line of codes are based on https://hackernoon.com/simple-guide-on-how-to-generate-roc-plot-for-keras-classifier-2ecc6c73115a
#import numpy as np
